<!--
	Borrowed from @huntabytes shadcn-svelte repo
	https://github.com/huntabyte/shadcn-svelte/blob/main/docs/src/lib/components/component-preview-tab.svelte
-->
<script lang="ts">
