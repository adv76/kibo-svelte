...
{#snippet ScotiaBankLogo(className?: string)}
    <svg viewBox="0 0 72.13 10.5" xmlns="http://www.w3.org/2000/svg" class={className}>
...
{#snippet ScenePlusMark(className: string)}
      <svg
        fill="none"
        viewBox="0 0 110 35"
...
<CreditCard.Root>
    <CreditCard.Flipper>
        <CreditCard.Front class="bg-[#321419]">
            {@render ScotiaBankLogo("absolute top-0 left-0 h-1/10")}
            <CreditCard.Logo>
                {@render ScenePlusMark("text-[#0e72d1]")}
            </CreditCard.Logo>
            <CreditCard.Chip />
        ...
        <CreditCard.Back class="bg-[#321419]">
            <CreditCard.MagStripe class="bg-white/20" />
