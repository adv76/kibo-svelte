<script lang="ts">
    import * as Story from "$lib/registry/components/stories";
...
<Story.ContainerRoot>
    <Story.ContainerContent>
        {#each stories as story(story.id)}
            <Story.Root class="aspect-[3/4] w-[200px] basis-[200px]">
                <Story.Image alt={story.title} src={story.preview} />
                <Story.Overlay side="top" />
                <Story.Overlay side="bottom" />
                <Story.Title class="truncate font-medium text-sm">
                    {story.title}
                </Story.Title>
                <Story.Author>
                    <Story.AuthorImage
                        ...
                        src={story.avatar}
                    />
                    <Story.AuthorName>{story.author}</Story.AuthorName>
                </Story.Author>
            </Story.Root>
        {/each}
    </Story.ContainerContent>
